...
module HelpScout
  ...
  class Rating
    attr_reader :number, :id, :type, :threadid, :threadCreatedAt, :ratingId, :ratingCustomerId, :ratingComments, :ratingCreatedAt, :ratingCustomerName, :ratingUserId, :ratingUserName
